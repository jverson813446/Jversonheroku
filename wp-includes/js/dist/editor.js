...
this["wp"]["editor"] = /******/ (function (modules) {
  ...
  /******/ {
    ...
    /***/ CNgt: /***/ function (module, exports, __webpack_require__) {
      "use strict";
    ...
    /***/ GemG: /***/ function (module, exports, __webpack_require__) {
...
*/
    ...
    /***/ O6Fj: /***/ function (module, exports, __webpack_require__) {
      "use strict";
    ...
    /***/ PLxR: /***/ function (
      ...
      __webpack_require__.d(
        ...
        "getEditorSelection",
        function () {
          return selectors_getEditorSelection;
        }
      );
      __webpack_require__.d(
        selectors_namespaceObject,
      ...
      __webpack_require__.d(
        ...
        "getGlobalBlockCount",
        function () {
          return selectors_getGlobalBlockCount;
        }
      );
      __webpack_require__.d(
        selectors_namespaceObject,
      ...
      __webpack_require__.d(
        ...
        "setTemplateValidity",
        function () {
          return actions_setTemplateValidity;
        }
      );
      __webpack_require__.d(
        actions_namespaceObject,
        "synchronizeTemplate",
        function () {
          return actions_synchronizeTemplate;
        }
      );
      __webpack_require__.d(
        actions_namespaceObject,
        ...
        Object(external_wp_compose_["createHigherOrderComponent"])(
          (BlockEdit) =>
            ({ attributes, setAttributes, ...props }) => {
              ...
              const [meta, setMeta] = Object(
                external_wp_coreData_["useEntityProp"]
              )("postType", postType, "meta");
              const mergedAttributes = Object(external_wp_element_["useMemo"])(
                () => ({
                  ...attributes,
                ...
                Object(esm_extends["a" /* default */])(
                  {
                    ...
                    setAttributes: (nextAttributes) => {
                      const nextMeta = Object(external_lodash_["mapKeys"])(
      ...
      function shimAttributeSource(settings) {
        ...
        const metaAttributes = Object(external_lodash_["mapValues"])(
      ...
      function preferences(state = PREFERENCES_DEFAULTS, action) {
        switch (action.type) {
          case "ENABLE_PUBLISH_SIDEBAR":
            return { ...state, isPublishSidebarEnabled: true };

          case "DISABLE_PUBLISH_SIDEBAR":
            return { ...state, isPublishSidebarEnabled: false };
        }
      ...
      function reducer_editorSettings(
        state = EDITOR_SETTINGS_DEFAULTS,
        action
      ) {
        switch (action.type) {
      ...
      const header = Object(external_wp_element_["createElement"])(
      ...
      const footer = Object(external_wp_element_["createElement"])(
        external_wp_primitives_["SVG"],
        {
          xmlns: "https://www.w3.org/2000/svg",
          viewBox: "0 0 24 24",
      ...
      const sidebar = Object(external_wp_element_["createElement"])(
        external_wp_primitives_["SVG"],
        {
          xmlns: "https://www.w3.org/2000/svg",
          viewBox: "0 0 24 24",
      ...
      const hasEditorUndo = Object(external_wp_data_["createRegistrySelector"])(
        (select) => () => {
      ...
      const hasEditorRedo = Object(external_wp_data_["createRegistrySelector"])(
        (select) => () => {
      ...
      const selectors_isEditedPostDirty = Object(
      ...
      const selectors_hasNonPostEntityChanges = Object(
        external_wp_data_["createRegistrySelector"]
      )((select) => (state) => {
        const dirtyEntityRecords =
          select("core").__experimentalGetDirtyEntityRecords();

        const { type, id } = selectors_getCurrentPost(state);
      ...
      const selectors_getCurrentPost = Object(
        external_wp_data_["createRegistrySelector"]
      )((select) => (state) => {
        const postId = selectors_getCurrentPostId(state);
        const postType = selectors_getCurrentPostType(state);
      ...
      const selectors_getPostEdits = Object(
        external_wp_data_["createRegistrySelector"]
      )((select) => (state) => {
        const postType = selectors_getCurrentPostType(state);
        const postId = selectors_getCurrentPostId(state);
      ...
      const getReferenceByDistinctEdits = Object(
        external_wp_data_["createRegistrySelector"]
      )((select) => () =>
        /* state */
        {
      ...
      const getAutosaveAttribute = Object(
        external_wp_data_["createRegistrySelector"]
        ...
        const postType = selectors_getCurrentPostType(state);
        const postId = selectors_getCurrentPostId(state);
        const currentUserId = Object(external_lodash_["get"])(
      ...
      const selectors_isEditedPostAutosaveable = Object(
        external_wp_data_["createRegistrySelector"]
      )((select) => (state) => {
      ...
      const getAutosave = Object(external_wp_data_["createRegistrySelector"])(
        (select) => (state) => {
          external_wp_deprecated_default()(
      ...
      const hasAutosave = Object(external_wp_data_["createRegistrySelector"])(
        (select) => (state) => {
          external_wp_deprecated_default()(
      ...
      const selectors_isSavingPost = Object(
        external_wp_data_["createRegistrySelector"]
      )((select) => (state) => {
        const postType = selectors_getCurrentPostType(state);
        const postId = selectors_getCurrentPostId(state);
      ...
      const didPostSaveRequestSucceed = Object(
        external_wp_data_["createRegistrySelector"]
      )((select) => (state) => {
        const postType = selectors_getCurrentPostType(state);
        const postId = selectors_getCurrentPostId(state);
      ...
      const didPostSaveRequestFail = Object(
        external_wp_data_["createRegistrySelector"]
      )((select) => (state) => {
        const postType = selectors_getCurrentPostType(state);
        const postId = selectors_getCurrentPostId(state);
      ...
      function selectors_getEditedPostPreviewLink(state) {
        ...
        const featuredImageId = selectors_getEditedPostAttribute(
          state,
          "featured_media"
        );
      ...
      const getEditedPostContent = Object(
        external_wp_data_["createRegistrySelector"]
      )((select) => (state) => {
        const postId = selectors_getCurrentPostId(state);
        const postType = selectors_getCurrentPostType(state);
      ...
      function isPermalinkEditable(state) {
        const permalinkTemplate = selectors_getEditedPostAttribute(
          state,
          "permalink_template"
        );
      ...
      function getEditorSelectionStart(state) {
        ...
        return (_getEditedPostAttribu = selectors_getEditedPostAttribute(
          state,
          "selection"
      ...
      function getEditorSelectionEnd(state) {
        ...
        return (_getEditedPostAttribu2 = selectors_getEditedPostAttribute(
          state,
          "selection"
      ...
      function getBlockEditorSelector(name) {
        return Object(external_wp_data_["createRegistrySelector"])(
          (select) =>
            (state, ...args) => {
              external_wp_deprecated_default()(
      ...
      const __unstableGetBlockWithoutInnerBlocks = getBlockEditorSelector(
        "__unstableGetBlockWithoutInnerBlocks"
      );
      /**
      ...
      const selectors_getGlobalBlockCount = getBlockEditorSelector(
        "getGlobalBlockCount"
      );
      /**
      ...
      const __experimentalGetDefaultTemplatePartAreas = Object(
        rememo["a" /* default */]
      )(
        (state) => {
          ...
          const areas =
            ((_getEditorSettings2 = selectors_getEditorSettings(state)) ===
              null || _getEditorSettings2 === void 0
              ? void 0
        ...
        (state) => {
          ...
          return [
            (_getEditorSettings3 = selectors_getEditorSettings(state)) ===
              null || _getEditorSettings3 === void 0
              ? void 0
      ...
      const __experimentalGetDefaultTemplateType = Object(
        rememo["a" /* default */]
      )(
        (state, slug) =>
      ...
      function __experimentalGetTemplateInfo(state, template) {
        ...
        const templateTitle = Object(external_lodash_["isString"])(title)
          ? title
          : title === null || title === void 0
          ? void 0
          : title.rendered;
        const templateDescription = Object(external_lodash_["isString"])(
          excerpt
        )
          ? excerpt
        ...
        const templateIcon =
          ...
          _experimentalGetDefa === void 0
            ? void 0
            : _experimentalGetDefa.icon) || layout["a" /* default */];
        return {
          title:
      ...
      function getNotificationArgumentsForSaveSuccess(data) {
        ...
        const isPublished = Object(external_lodash_["includes"])(
          publishStatus,
          previousPost.status
        );
        const willPublish = Object(external_lodash_["includes"])(
          publishStatus,
          post.status
        );
        let noticeMessage;
        let shouldShowLink = Object(external_lodash_["get"])(
          postType,
          ["viewable"],
          false
        );
      ...
      function* actions_setupEditor(post, edits, template) {
        ...
        if (isNewPost && template) {
          blocks = Object(external_wp_blocks_["synchronizeBlocksWithTemplate"])(
            blocks,
            template
          );
        }
      ...
      function* resetAutosave(newAutosave) {
        ...
        const postId = yield external_wp_data_["controls"].select(
          STORE_NAME,
          "getCurrentPostId"
        );
      ...
      function* actions_editPost(edits, options) {
        const { id, type } = yield external_wp_data_["controls"].select(
          STORE_NAME,
          "getCurrentPost"
        );
        yield external_wp_data_["controls"].dispatch(
      ...
      function* actions_savePost(options = {}) {
        if (
          !(yield external_wp_data_["controls"].select(
            STORE_NAME,
            "isEditedPostSaveable"
          ))
        ) {
        ...
        let edits = {
          content: yield external_wp_data_["controls"].select(
            STORE_NAME,
            "getEditedPostContent"
          ),
        };
        ...
        const previousRecord = yield external_wp_data_["controls"].select(
          STORE_NAME,
          "getCurrentPost"
        );
        edits = {
        ...
        const error = yield external_wp_data_["controls"].select(
          "core",
        ...
        if (error) {
          ...
          const updatedRecord = yield external_wp_data_["controls"].select(
            STORE_NAME,
            "getCurrentPost"
          );
          const args = getNotificationArgumentsForSaveSuccess({
            ...
            post: updatedRecord,
            postType: yield external_wp_data_["controls"].resolveSelect(
              "core",
              "getPostType",
              updatedRecord.type
            ),
      ...
      function* refreshPost() {
        ...
        const postTypeSlug = yield external_wp_data_["controls"].select(
          STORE_NAME,
          "getCurrentPostType"
        );
        const postType = yield external_wp_data_["controls"].resolveSelect(
          "core",
          "getPostType",
          postTypeSlug
        );
      ...
      function* actions_autosave({ local = false, ...options } = {}) {
        if (local) {
          const post = yield external_wp_data_["controls"].select(
            STORE_NAME,
            "getCurrentPost"
          );
          const isPostNew = yield external_wp_data_["controls"].select(
            STORE_NAME,
            "isEditedPostNew"
          );
          const title = yield external_wp_data_["controls"].select(
            STORE_NAME,
            "getEditedPostAttribute",
            "title"
          );
          const content = yield external_wp_data_["controls"].select(
            STORE_NAME,
            "getEditedPostAttribute",
            "content"
          );
          const excerpt = yield external_wp_data_["controls"].select(
            STORE_NAME,
            "getEditedPostAttribute",
            "excerpt"
          );
      ...
      function* actions_resetEditorBlocks(blocks, options = {}) {
        ...
        if (__unstableShouldCreateUndoLevel !== false) {
          ...
          if (noChange) {
            return yield external_wp_data_["controls"].dispatch(
              "core",
          ...
          edits.content = ({ blocks: blocksForSerialization = [] }) =>
            Object(external_wp_blocks_["__unstableSerializeAndClean"])(
      ...
      const actions_clearSelectedBlock =
        getBlockEditorAction("clearSelectedBlock");
      /**
      ...
      const actions_setTemplateValidity = getBlockEditorAction(
        "setTemplateValidity"
      );
      /**
      ...
      const actions_synchronizeTemplate = getBlockEditorAction(
        "synchronizeTemplate"
      );
      /**
      ...
      const actions_insertDefaultBlock =
      ...
      class autosave_monitor_AutosaveMonitor extends external_wp_element_[
        "Component"
      ] {
        constructor(props) {
          super(props);
      ...
      const emptyHeadingContent = Object(external_wp_element_["createElement"])(
        "em",
        null,
      ...
      const DocumentOutline = ({
        ...
        const countByLevel = Object(external_lodash_["countBy"])(
          headings,
          "level"
        );
      ...
      /* harmony default export */ var document_outline = Object(
        ...
        Object(external_wp_data_["withSelect"])((select) => {
          const { getBlocks } = select(external_wp_blockEditor_["store"]);
      ...
      function DocumentOutlineCheck({ blocks, children }) {
        const headings = Object(external_lodash_["filter"])(
          blocks,
      ...
      function SaveShortcut({ resetBlocksOnSave }) {
        const { resetEditorBlocks, savePost } = Object(
          external_wp_data_["useDispatch"]
        )("core/editor");
        const { isEditedPostDirty, getPostEdits } = Object(
      ...
      function EditorHistoryRedo(props, ref) {
        ...
        const { redo } = Object(external_wp_data_["useDispatch"])(store);
        return Object(external_wp_element_["createElement"])(
          ...
          Object(esm_extends["a" /* default */])({}, props, {
            ...
            shortcut:
              external_wp_keycodes_["displayShortcut"].primaryShift("z"), // If there are no redo levels we don't want to actually disable this
      ...
      function EditorHistoryUndo(props, ref) {
        ...
        const { undo } = Object(external_wp_data_["useDispatch"])(store);
        return Object(external_wp_element_["createElement"])(
          external_wp_components_["Button"],
          Object(esm_extends["a" /* default */])({}, props, {
            ref: ref,
      ...
      function EditorNotices({ notices, onRemove }) {
      ...
      function EditorSnackbars() {
        const notices = Object(external_wp_data_["useSelect"])(
          (select) => select(external_wp_notices_["store"]).getNotices(),
          []
        );
      ...
      const page_page = Object(external_wp_element_["createElement"])(
        external_wp_primitives_["SVG"],
        {
          xmlns: "https://www.w3.org/2000/svg",
          viewBox: "0 0 24 24",
      ...
      function EntityRecordItem({ record, checked, onChange, closePanel }) {
        const { name, kind, title, key } = record;
        const parentBlockId = Object(external_wp_data_["useSelect"])(
          (select) => {
            var _blocks$;
        ...
        const entityRecordTitle = Object(external_wp_data_["useSelect"])(
          (select) => {
        ...
        const selectParentBlock = Object(external_wp_element_["useCallback"])(
          () => selectBlock(parentBlockId),
          [parentBlockId]
        );
        const selectAndDismiss = Object(
      ...
      function EntityTypeList({
        ...
        const entity = Object(external_wp_data_["useSelect"])(
          (select) =>
            select(external_wp_coreData_["store"]).getEntity(
              firstRecord.kind,
              firstRecord.name
            ),
      ...
      function EntitiesSavedStates({ close }) {
        const saveButtonRef = Object(external_wp_element_["useRef"])();
        const { dirtyEntityRecords } = Object(external_wp_data_["useSelect"])(
          (select) => {
        ...
        } = Object(external_wp_data_["useDispatch"])(
          external_wp_coreData_["store"]
        ...
        const [unselectedEntities, _setUnselectedEntities] = Object(
        ...
        const dismissPanel = Object(external_wp_element_["useCallback"])(
          () => close(),
          [close]
        );
        const [saveDialogRef, saveDialogProps] = Object(
      ...
      /* harmony default export */ var error_boundary =
      ...
      function useAutosaveNotice() {
        const { postId, isEditedPostNew, hasRemoteAutosave } = Object(
          external_wp_data_["useSelect"]
        )(
          (select) => ({
            ...
            hasRemoteAutosave:
              !!select("core/editor").getEditorSettings().autosave,
          }),
          []
        );
        const { getEditedPostAttribute } = Object(
          external_wp_data_["useSelect"]
        )("core/editor");
        const { createWarningNotice, removeNotice } = Object(
          external_wp_data_["useDispatch"]
        )(external_wp_notices_["store"]);
        const { editPost, resetEditorBlocks } = Object(
          external_wp_data_["useDispatch"]
        )("core/editor");
        Object(external_wp_element_["useEffect"])(() => {
          ...
          const noticeId = Object(external_lodash_["uniqueId"])(
      ...
      function useAutosavePurge() {
        ...
        const lastIsAutosaving = Object(external_wp_element_["useRef"])(
          isAutosaving
        );
        Object(external_wp_element_["useEffect"])(() => {
          if (
        ...
        const wasEditedPostNew = Object(external_wp_compose_["usePrevious"])(
          isEditedPostNew
        );
      ...
      function LocalAutosaveMonitor() {
        const { autosave } = Object(external_wp_data_["useDispatch"])(
          "core/editor"
        );
        const deferedAutosave = Object(
          external_wp_element_["useCallback"]
        )(() => {
          requestIdleCallback(() =>
            autosave({
        ...
        useAutosaveNotice();
        useAutosavePurge();
        const { localAutosaveInterval } = Object(
          external_wp_data_["useSelect"]
        )(
          (select) => ({
      ...
      function PageAttributesCheck({ children }) {
        const postType = Object(external_wp_data_["useSelect"])((select) => {
          const { getEditedPostAttribute } = select(store);
          const { getPostType } = select(external_wp_coreData_["store"]);
          return getPostType(getEditedPostAttribute("type"));
        }, []);
        const supportsPageAttributes = Object(external_lodash_["get"])(
          postType,
      ...
      function buildTermsTree(flatTerms) {
        ...
        const termsByParent = Object(external_lodash_["groupBy"])(
      ...
      function getTitle(post) {
        ...
        return post !== null &&
          ...
          : `#${post.id} (${Object(external_wp_i18n_["__"])("no title")})`;
      }

      const getItemPriority = (name, searchValue) => {
        const normalizedName = Object(external_lodash_["deburr"])(
          name
        ).toLowerCase();
        const normalizedSearch = Object(external_lodash_["deburr"])(
          searchValue
        ).toLowerCase();
      ...
      function PageAttributesParent() {
        ...
        const [fieldValue, setFieldValue] = Object(
          external_wp_element_["useState"]
        )(false);
        const { parentPost, parentPostId, items, postType } = Object(
          external_wp_data_["useSelect"]
        )(
          (select) => {
            ...
            const isHierarchical = Object(external_lodash_["get"])(
              pType,
              ["hierarchical"],
              false
            );
        ...
        const parentPageLabel = Object(external_lodash_["get"])(postType, [
          "labels",
          "parent_item_colon",
        ]);
        ...
        const parentOptions = Object(external_wp_element_["useMemo"])(() => {
          ...
          const optsHasParent = Object(external_lodash_["find"])(
            opts,
      ...
      function PostTemplate({}) {
        const { availableTemplates, selectedTemplate, isViewable } = Object(
          external_wp_data_["useSelect"]
        )((select) => {
        ...
        const { editPost } = Object(external_wp_data_["useDispatch"])(store);
      ...
      function PostAuthorCombobox() {
        ...
        const { authorId, isLoading, authors, postAuthor } = Object(
          external_wp_data_["useSelect"]
        )(
          (select) => {
      ...
      function PostAuthorSelect() {
        ...
        const { postAuthor, authors } = Object(external_wp_data_["useSelect"])(
          (select) => {
      ...
      function PostAuthor() {
        const showCombobox = Object(external_wp_data_["useSelect"])(
          (select) => {
      ...
      function PostAuthorCheck({ hasAssignAuthorAction, authors, children }) {
      ...
      /* harmony default export */ var post_comments = Object(
        ...
        Object(external_wp_data_["withSelect"])((select) => {
          return {
            commentStatus:
              select("core/editor").getEditedPostAttribute("comment_status"),
          };
        }),
        Object(external_wp_data_["withDispatch"])((dispatch) => ({
      ...
      function ThemeSupportCheck({
        ...
        const isSupported = Object(external_lodash_["some"])(
          Object(external_lodash_["castArray"])(supportKeys),
          (key) => {
            const supported = Object(external_lodash_["get"])(
              themeSupports,
              [key],
              false
      ...
      const DEFAULT_FEATURE_IMAGE_LABEL = Object(external_wp_i18n_["__"])(
        "Featured image"
      );

      const DEFAULT_SET_FEATURE_IMAGE_LABEL = Object(external_wp_i18n_["__"])(
        "Set featured image"
      );

      const DEFAULT_REMOVE_FEATURE_IMAGE_LABEL = Object(
        external_wp_i18n_["__"]
      )("Remove image");
      ...
      function PostFeaturedImage({
        ...
        const postLabel = Object(external_lodash_["get"])(
          postType,
          ["labels"],
          {}
        );
        const instructions = Object(external_wp_element_["createElement"])(
          "p",
          null,
          Object(external_wp_i18n_["__"])(
        ...
        if (media) {
          const mediaSize = Object(external_wp_hooks_["applyFilters"])(
          ...
          if (
            ...
            const fallbackMediaSize = Object(
              external_wp_hooks_["applyFilters"]
            )(
              "editor.PostFeaturedImage.imageSize",
              "thumbnail",
              media.id,
      ...
      function PostFormat() {
        ...
        const { postFormat, suggestedFormat, supportedFormats } = Object(
          external_wp_data_["useSelect"]
        )((select) => {
        ...
        const formats = POST_FORMATS.filter((format) =>
          Object(external_lodash_["includes"])(supportedFormats, format.id)
        );
        const suggestion = Object(external_lodash_["find"])(
          formats,
      ...
      const backup = Object(external_wp_element_["createElement"])(
        external_wp_primitives_["SVG"],
        {
          xmlns: "https://www.w3.org/2000/svg",
          viewBox: "0 0 24 24",
      ...
      function writeInterstitialMessage(targetDocument) {
        let markup = Object(external_wp_element_["renderToString"])(
          Object(external_wp_element_["createElement"])(
            "div",
            {
	...
	`;
      ...
      class post_preview_button_PostPreviewButton extends external_wp_element_[
        "Component"
      ] {
        constructor() {
          super(...arguments);
          ...
          return Object(external_wp_element_["createElement"])(
            ...
            this.props.textContent
              ...
              : Object(external_wp_element_["createElement"])(
                  external_wp_element_["Fragment"],
                  null,
                  Object(external_wp_i18n_["_x"])("Preview", "imperative verb"),
                  Object(external_wp_element_["createElement"])(
      ...
      /* harmony default export */ var post_preview_button = Object(
        ...
        Object(external_wp_data_["withSelect"])(
          (select, { forcePreviewLink, forceIsAutosaveable }) => {
            const {
              getCurrentPostId,
              getCurrentPostAttribute,
              getEditedPostAttribute,
      ...
      function PostLockedModal() {
        ...
        const { autosave, updatePostLock } = Object(
          external_wp_data_["useDispatch"]
        )("core/editor");
        const {
          isLocked,
        ...
        const allPostsLabel = Object(external_wp_i18n_["__"])(
          "Exit the Editor"
        );
      ...
      function PostPendingStatus({ status, onUpdateStatus }) {
      ...
      /* harmony default export */ var post_pingbacks = Object(
        ...
        Object(external_wp_data_["withSelect"])((select) => {
          return {
            pingStatus:
              select("core/editor").getEditedPostAttribute("ping_status"),
          };
        }),
        Object(external_wp_data_["withDispatch"])((dispatch) => ({
          editPost: dispatch("core/editor").editPost,
      ...
      /* harmony default export */ var post_publish_button_label = Object(
        ...
        Object(external_wp_data_["withSelect"])((select, { forceIsSaving }) => {
          const {
            isCurrentPostPublished,
            isEditedPostBeingScheduled,
            isSavingPost,
      ...
      class post_publish_button_PostPublishButton extends external_wp_element_[
        "Component"
      ] {
        constructor(props) {
          super(props);
        ...
        render() {
          ...
          const buttonChildren = Object(external_wp_element_["createElement"])(
      ...
      class post_visibility_PostVisibility extends external_wp_element_[
        "Component"
      ] {
        constructor(props) {
          super(...arguments);
        ...
        setPasswordProtected() {
          const { visibility, onUpdateVisibility, status, password } =
            this.props;
          onUpdateVisibility(
      ...
      function PostVisibilityLabel({ visibility }) {
        const getVisibilityLabel = () =>
          Object(external_lodash_["find"])(visibilityOptions, {
            value: visibility,
          }).label;
      ...
      function PostSchedule() {
        const { postDate, postType } = Object(external_wp_data_["useSelect"])(
          (select) => ({
        ...
        const [previewedMonth, setPreviewedMonth] = Object(
          external_wp_element_["useState"]
        )(getDayOfTheMonth(postDate)); // Pick up published and schduled site posts.

        const eventsByPostType = Object(external_wp_data_["useSelect"])(
          (select) =>
        ...
        const events = Object(external_wp_element_["useMemo"])(
          () =>
            (eventsByPostType || []).map(
              ({ title, type, date: eventDate }) => ({
                title:
                  title === null || title === void 0 ? void 0 : title.rendered,
                type,
        ...
        const settings = Object(
          external_wp_date_["__experimentalGetSettings"]
      ...
      function PostScheduleLabel({ date, isFloating }) {
        const settings = Object(
          external_wp_date_["__experimentalGetSettings"]
        )();
      ...
      function MostUsedTerms({ onSelect, taxonomy }) {
        const { _terms, showTerms } = Object(external_wp_data_["useSelect"])(
          (select) => {
            ...
            return {
              ...
              showTerms:
                (mostUsedTerms === null || mostUsedTerms === void 0
                  ? void 0
                  : mostUsedTerms.length) >= MAX_MOST_USED_TERMS,
            };
          },
          []
        );
        ...
        const label = Object(external_lodash_["get"])(taxonomy, [
          "labels",
          "most_used",
        ]);
        return Object(external_wp_element_["createElement"])(
      ...
      const termNamesToIds = (names, terms) => {
        return names.map(
          (termName) =>
            Object(external_lodash_["find"])(terms, (term) =>
              isSameTermName(term.name, termName)
            ).id
        );
      };

      class flat_term_selector_FlatTermSelector extends external_wp_element_[
        "Component"
      ] {
        constructor() {
          super(...arguments);
          this.onChange = this.onChange.bind(this);
          this.searchTerms = Object(external_lodash_["debounce"])(
            this.searchTerms.bind(this),
            500
          );
        ...
        fetchTerms(params = {}) {
          ...
          const query = { ...flat_term_selector_DEFAULT_QUERY, ...params };
        ...
        updateSelectedTerms(terms = []) {
          const selectedTerms = terms.reduce((accumulator, termId) => {
            const termObject = Object(external_lodash_["find"])(
              ...
              if (errorCode === "term_exists") {
                ...
                return this.addRequest.then((searchResult) => {
                  return Object(external_lodash_["find"])(
                    searchResult,
                    (result) => isSameTermName(result.name, termName)
                  );
                });
              }
        ...
        onChange(termNames) {
          const uniqueTerms = Object(external_lodash_["uniqBy"])(
            termNames,
          ...
          Promise.all(newTermNames.map(this.findOrCreateTerm)).then(
            (newTerms) => {
              const newAvailableTerms =
                this.state.availableTerms.concat(newTerms);
              this.setState({
        ...
        render() {
          ...
          const newTermLabel = Object(external_lodash_["get"])(
            taxonomy,
            ["labels", "add_new_item"],
            slug === "post_tag"
          ...
          const singularName = Object(external_lodash_["get"])(
            taxonomy,
            ["labels", "singular_name"],
            slug === "post_tag"
              ? Object(external_wp_i18n_["__"])("Tag")
      ...
      /* harmony default export */ var flat_term_selector = Object(
        ...
        Object(external_wp_data_["withSelect"])((select, { slug }) => {
          const { getCurrentPost } = select(store);
          const { getTaxonomy } = select(external_wp_coreData_["store"]);
          ...
          return {
            ...
            hasAssignAction: taxonomy
              ...
              : false,
            terms: taxonomy
              ? select(store).getEditedPostAttribute(taxonomy.rest_base)
              : [],
            taxonomy,
          };
        }),
      ...
      class maybe_tags_panel_MaybeTagsPanel extends external_wp_element_[
        "Component"
      ] {
        constructor(props) {
          super(props);
      ...
      const getSuggestion = (supportedFormats, suggestedPostFormat) => {
        ...
        return Object(external_lodash_["find"])(
          formats,
          (format) => format.id === suggestedPostFormat
        );
      };
      ...
      function PostFormatPanel() {
        const { currentPostFormat, suggestion } = Object(
          external_wp_data_["useSelect"]
        )((select) => {
          const { getEditedPostAttribute, getSuggestedPostFormat } =
            select("core/editor");
          const supportedFormats = Object(external_lodash_["get"])(
      ...
      function PostPublishPanelPrepublish({ children }) {
        const {
          ...
          return {
            ...
            siteHome:
              siteData.home &&
              Object(external_wp_url_["filterURLForDisplay"])(siteData.home),
          };
        }, []);
        let siteIcon = Object(external_wp_element_["createElement"])(
          ...
          Object(external_wp_element_["createElement"])(
            ...
            Object(external_wp_element_["createElement"])(
              ...
              Object(external_wp_element_["createElement"])(
                ...
                siteTitle || Object(external_wp_i18n_["__"])("(Untitled)")
              ),
              Object(external_wp_element_["createElement"])(
                "span",
                {
      ...
      function postpublish_CopyButton({ text, onCopy, children }) {
      ...
      class postpublish_PostPublishPanelPostpublish extends external_wp_element_[
        "Component"
      ] {
        constructor() {
          super(...arguments);
        ...
        render() {
          ...
          const postLabel = Object(external_lodash_["get"])(postType, [
            "labels",
            "singular_name",
          ]);
          const viewPostLabel = Object(external_lodash_["get"])(postType, [
            "labels",
            "view_item",
          ]);
          const link =
      ...
      class post_publish_panel_PostPublishPanel extends external_wp_element_[
        "Component"
      ] {
        constructor() {
          super(...arguments);
        ...
        render() {
          ...
          const propsForPanel = Object(external_lodash_["omit"])(
            additionalProps,
      ...
      /* harmony default export */ var post_publish_panel = Object(
        ...
        Object(external_wp_data_["withDispatch"])(
          (dispatch, { isPublishSidebarEnabled }) => {
      ...
      const cloud = Object(external_wp_element_["createElement"])(
        external_wp_primitives_["SVG"],
        {
          xmlns: "https://www.w3.org/2000/svg",
          viewBox: "0 0 24 24",
      ...
      const cloudUpload = Object(external_wp_element_["createElement"])(
        external_wp_primitives_["SVG"],
        {
          xmlns: "https://www.w3.org/2000/svg",
          viewBox: "0 0 24 24",
      ...
      function PostSavedState({
        ...
        const [forceSavedMessage, setForceSavedMessage] = Object(
          external_wp_element_["useState"]
        )(false);
        ...
        const { savePost } = Object(external_wp_data_["useDispatch"])(
          "core/editor"
        );
      ...
      function PostScheduleCheck({ hasPublishAction, children }) {
        if (!hasPublishAction) {
          return null;
        }
      ...
      function PostSlugCheck({ children }) {
        return Object(external_wp_element_["createElement"])(
          post_type_support_check,
          {
            supportKeys: "slug",
      ...
      function PostStickyCheck({ hasStickyAction, postType, children }) {
      ...
      function PostSticky({ onUpdateSticky, postSticky = false }) {
        return Object(external_wp_element_["createElement"])(
          post_sticky_check,
          null,
          Object(external_wp_element_["createElement"])(
      ...
      class hierarchical_term_selector_HierarchicalTermSelector extends external_wp_element_[
        "Component"
      ] {
        constructor() {
          super(...arguments);
        ...
        onAddTerm(event) {
          ...
          findOrCreatePromise.then(
            (term) => {
              const hasTerm = !!Object(external_lodash_["find"])(
                this.state.availableTerms,
                (availableTerm) => availableTerm.id === term.id
              );
        ...
        render() {
          ...
          const filterLabel = Object(external_lodash_["get"])(
            this.props.taxonomy,
            ["labels", "search_items"],
            Object(external_wp_i18n_["__"])("Search Terms")
          );
          const groupLabel = Object(external_lodash_["get"])(
            this.props.taxonomy,
            ["name"],
      ...
      function PostTaxonomies({
        ...
        const availableTaxonomies = Object(external_lodash_["filter"])(
          taxonomies,
          (taxonomy) =>
            Object(external_lodash_["includes"])(taxonomy.types, postType)
        );
        const visibleTaxonomies = Object(external_lodash_["filter"])(
          availableTaxonomies,
      ...
      function PostTaxonomiesCheck({ postType, taxonomies, children }) {
        const hasTaxonomies = Object(external_lodash_["some"])(
          taxonomies,
          (taxonomy) =>
            Object(external_lodash_["includes"])(taxonomy.types, postType)
        );
      ...
      function PostTextEditor() {
        const postContent = Object(external_wp_data_["useSelect"])(
        ...
        const [value, setValue] = Object(external_wp_element_["useState"])(
          postContent
        );
        const [isDirty, setIsDirty] = Object(external_wp_element_["useState"])(
          false
        );
        const instanceId = Object(external_wp_compose_["useInstanceId"])(
          PostTextEditor
      ...
      function PostTitle() {
        ...
        const ref = Object(external_wp_element_["useRef"])();
        const [isSelected, setIsSelected] = Object(
          external_wp_element_["useState"]
        )(false);
        const { editPost } = Object(external_wp_data_["useDispatch"])(
          "core/editor"
        );
        const { insertDefaultBlock, clearSelectedBlock, insertBlocks } = Object(
          external_wp_data_["useDispatch"]
        )(external_wp_blockEditor_["store"]);
        const {
          isCleanNewPost,
        ...
        const decodedPlaceholder = Object(
      ...
      function PostVisibilityCheck({ hasPublishAction, render }) {
      ...
      const info_info = Object(external_wp_element_["createElement"])(
        external_wp_primitives_["SVG"],
        {
          xmlns: "https://www.w3.org/2000/svg",
          viewBox: "0 0 24 24",
      ...
      function WordCount() {
        const content = Object(external_wp_data_["useSelect"])((select) =>
        ...
        const wordCountType = Object(external_wp_i18n_["_x"])(
          "words",
      ...
      function TableOfContentsPanel({
        ...
        const { headingCount, paragraphCount, numberOfBlocks } = Object(
          external_wp_data_["useSelect"]
        )((select) => {
      ...
      function TableOfContents(
        ...
        const hasBlocks = Object(external_wp_data_["useSelect"])(
          (select) =>
            !!select(external_wp_blockEditor_["store"]).getBlockCount(),
          []
        );
        return Object(external_wp_element_["createElement"])(
      ...
      const withRegistryProvider = Object(
        external_wp_compose_["createHigherOrderComponent"]
      )(
        (WrappedComponent) =>
          Object(external_wp_data_["withRegistry"])((props) => {
            const {
              useSubRegistry = true,
              registry,
              ...additionalProps
            ...
            const [subRegistry, setSubRegistry] = Object(
              external_wp_element_["useState"]
            )(null);
            Object(external_wp_element_["useEffect"])(() => {
      ...
      function mediaUpload({
        ...
        const { getCurrentPostId, getEditorSettings } = Object(
          external_wp_data_["select"]
        )("core/editor");
      ...
      function useBlockEditorSettings(settings, hasTemplate) {
        const {
          ...
          const { canUserUseUnfilteredHTML, isPostTitleSelected } =
            select(store);
          const { canUser } = select(external_wp_coreData_["store"]);
          return {
        ...
        return Object(external_wp_element_["useMemo"])(
          () => ({
            ...
            __experimentalFetchLinkSuggestions: (search, searchOptions) =>
              Object(
                external_wp_coreData_["__experimentalFetchLinkSuggestions"]
              )(search, searchOptions, settings),
            __experimentalFetchRemoteUrlData: (url) =>
              Object(external_wp_coreData_["__experimentalFetchRemoteUrlData"])(
                url
              ),
      ...
      function EditorProvider({
        ...
        const defaultBlockContext = Object(
        ...
        const { selection, isReady } = Object(external_wp_data_["useSelect"])(
          (select) => {
        ...
        const editorSettings = use_block_editor_settings(
          settings,
          !!__unstableTemplate
        );
        const {
        ...
        const { createWarningNotice } = Object(
          external_wp_data_["useDispatch"]
        )(external_wp_notices_["store"]); // Iniitialize and tear down the editor.
      ...
      /* harmony default export */ var provider =
        with_registry_provider(EditorProvider);
      ...
      var external_wp_serverSideRender_default =
        /*#__PURE__*/ __webpack_require__.n(external_wp_serverSideRender_);
      ...
      function deprecateComponent(name, Wrapped, staticsToHoist = []) {
        const Component = Object(external_wp_element_["forwardRef"])(
          (props, ref) => {
      ...
      const deprecated_BlockEdit = deprecateComponent(
        "BlockEdit",
      ...
      const PreserveScrollInReorder = deprecateComponent(
        "PreserveScrollInReorder",
    ...
    /***/ Rk8H: /***/ function (module, exports, __webpack_require__) {
