...
this["wp"]["compose"] = /******/ (function (modules) {
  ...
  /******/ {
    ...
    /***/ PD33: /***/ function (
      ...
      /* harmony default export */ var create_higher_order_component =
        createHigherOrderComponent;
      ...
      const withInstanceId = create_higher_order_component(
        (WrappedComponent) => {
          return (props) => {
      ...
      const withSafeTimeout = create_higher_order_component(
        (OriginalComponent) => {
          return class WrappedComponent extends external_wp_element_[
            "Component"
          ] {
            constructor() {
              super(...arguments);
      ...
      var clipboard_default =
        /*#__PURE__*/ __webpack_require__.n(dist_clipboard);
      ...
      function useCopyOnClick(ref, text, timeout = 4000) {
        ...
        const [hasCopied, setHasCopied] = Object(
      ...
      function useFocusOnMount(focusOnMount = "firstElement") {
        const focusOnMountRef = Object(external_wp_element_["useRef"])(
          focusOnMount
        );
        Object(external_wp_element_["useEffect"])(() => {
        ...
        return Object(external_wp_element_["useCallback"])((node) => {
          ...
          if (focusOnMountRef.current === "firstElement") {
            const firstTabbable =
              external_wp_dom_["focus"].tabbable.find(node)[0];
      ...
      function useFocusReturn(onFocusReturn) {
        ...
        const onFocusReturnRef = Object(external_wp_element_["useRef"])(
          onFocusReturn
        );
        Object(external_wp_element_["useEffect"])(() => {
      ...
      function useFocusOutside(onFocusOutside) {
        const currentOnFocusOutside = Object(external_wp_element_["useRef"])(
          onFocusOutside
        );
        Object(external_wp_element_["useEffect"])(() => {
        ...
        const normalizeButtonFocus = Object(
          external_wp_element_["useCallback"]
        )((event) => {
        ...
        const queueBlurCheck = Object(external_wp_element_["useCallback"])(
          (event) => {
      ...
      function useMergeRefs(refs) {
        ...
        return Object(external_wp_element_["useCallback"])((value) => {
          ...
          const refsToAssign = value
            ? currentRefs.current
            : previousRefs.current; // Update the latest refs.
      ...
      function useDialog(options) {
        ...
        const closeOnEscapeRef = Object(external_wp_element_["useCallback"])(
          (node) => {
            if (!node) {
              return;
            }
      ...
      function useKeyboardShortcut(
        ...
        const currentCallback = Object(external_wp_element_["useRef"])(
          callback
        );
        Object(external_wp_element_["useEffect"])(() => {
        ...
        Object(external_wp_element_["useEffect"])(() => {
          ...
          const mousetrap = new mousetrap_default.a(
            target ? target.current : document
          );
          Object(external_lodash_["castArray"])(shortcuts).forEach(
            (shortcut) => {
      ...
      const ViewportMatchWidthContext = Object(
      ...
      function useAsyncList(list) {
        ...
        Object(external_wp_element_["useEffect"])(() => {
          ...
          const asyncQueue = Object(
            external_wp_priorityQueue_["createQueue"]
          )();
      ...
      function useDebounce(...args) {
        const debounced = Object(use_memo_one_esm["a" /* useMemoOne */])(
          () => Object(external_lodash_["debounce"])(...args),
          args
        );
        Object(external_wp_element_["useEffect"])(
          () => () => debounced.cancel(),
      ...
      function useThrottle(...args) {
        const throttled = Object(use_memo_one_esm["a" /* useMemoOne */])(
          () => Object(external_lodash_["throttle"])(...args),
          args
        );
        Object(external_wp_element_["useEffect"])(
          () => () => throttled.cancel(),
          ...
          return (
            (function (n, t) {
              var r = function () {
                return (
                  n.current &&
                  n.current.contentDocument &&
                  n.current.contentDocument.defaultView
                );
              };
              function u() {
                t();
    ...
    /***/ mHlH: /***/ function (
      ...
      function useMemoOne(getResult, inputs) {
        var initial = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(
          function () {
            return {
              inputs: inputs,
              result: getResult(),
        ...
        var isFirstRun = Object(react__WEBPACK_IMPORTED_MODULE_0__["useRef"])(
          true
        );
        var committed = Object(react__WEBPACK_IMPORTED_MODULE_0__["useRef"])(
          initial
        );
        var useCache =
          isFirstRun.current ||
        ...
        return /******/ (function () {
          ...
          /******/ var __webpack_modules__ = {
            /***/ 134: /***/ function (
              ...
              var select_default =
                /*#__PURE__*/ __webpack_require__.n(src_select); // CONCATENATED MODULE: ./src/clipboard-action.js
              ...
              /* harmony default export */ var clipboard_action =
                ClipboardAction; // CONCATENATED MODULE: ./src/clipboard.js
