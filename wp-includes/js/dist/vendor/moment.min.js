!(function (e, t) {
  ...
  function z(t, n) {
    return function (e) {
      return null != e
        ? (q(this, t, e), d.updateOffset(this, n), this)
        : $(this, t);
    };
  }
  function $(e, t) {
  ...
  function Ue(e) {
    return null != e
      ? (Ce(this, e), d.updateOffset(this, !0), this)
      : $(this, "Month");
  }
  function He() {
    function e(e, t) {
      ...
      t &&
        ...
        ((t =
          t[ve] < 0 || 11 < t[ve]
            ...
            ? Ye
            : -1),
        m(e)._overflowDayOfYear && (t < pe || ke < t) && (t = ke),
        m(e)._overflowWeeks && -1 === t && (t = Oe),
        m(e)._overflowWeekday && -1 === t && (t = be),
        (m(e).overflow = t)),
      e
    );
  }
          ...
          (n = l[h]),
            ...
            W[n]
              ? (t ? (m(e).empty = !1) : m(e).unusedTokens.push(n),
                (s = n),
                (r = e),
                null != (i = t) && c(_e, s) && _e[s](i, r._a, r, s))
  ...
  (d.createFromInputFallback = n(
    "value provided is not in a recognized RFC2822 or ISO format. moment construction falls back to js Date(), which is not reliable across all browsers and versions. Non RFC2822/ISO date formats are discouraged. Please refer to https://momentjs.com/guides/#/warnings/js-date/ for more info.",
    function (e) {
  ...
  function Ut(e) {
    ...
    (this._isValid = (function (e) {
      var t,
        ...
        s = !1;
      for (t in e)
        if (c(e, t) && (-1 === we.call(Ct, t) || (null != e[t] && isNaN(e[t]))))
          return !1;
    ...
    return (
      Ht(e)
        ...
        : "object" == typeof s &&
          ...
          (s.M = n.months)),
      (s = new Ut(s)),
      Ht(e) && c(e, "_locale") && (s._locale = e._locale),
      Ht(e) && c(e, "_isValid") && (s._isValid = e._isValid),
      s
    );
  }
  function $t(e, t) {
      ...
      if ("object" == typeof e)
        for (
          var n = (function (e) {
              var t,
                n = [];
              for (t in e) c(e, t) && n.push({ unit: t, priority: E[t] });
              return (
                n.sort(function (e, t) {
    ...
    (ie.eraYear = function () {
      for (
        ...
        if (
          ...
          return (this.year() - d(n[s].since).year()) * e + n[s].offset;
      return this.year();
    }),
    (ie.year = Le),
  ...
  (X.calendar = function (e, t, n) {
    ...
    (X.set = function (e) {
      var t, n;
      for (n in e)
        c(e, n) && (Y((t = e[n])) ? (this[n] = t) : (this["_" + n] = t));
      (this._config = e),
      ...
      for (
        ...
        switch (
          ("string" == typeof s[i].since &&
            ((n = d(s[i].since).startOf("day")), (s[i].since = n.valueOf())),
          typeof s[i].until)
        ) {
          case "undefined":
            s[i].until = 1 / 0;
            break;
          case "string":
            (n = d(s[i].until).startOf("day").valueOf()),
              (s[i].until = n.valueOf());
        }
      return s;
    }),
    ...
    (X.erasAbbrRegex = function (e) {
      return (
        c(this, "_erasAbbrRegex") || ln.call(this),
        e ? this._erasAbbrRegex : this._erasRegex
      );
    }),
    (X.erasNameRegex = function (e) {
      return (
        c(this, "_erasNameRegex") || ln.call(this),
        e ? this._erasNameRegex : this._erasRegex
      );
    }),
    (X.erasNarrowRegex = function (e) {
      return (
        c(this, "_erasNarrowRegex") || ln.call(this),
    ...
    (X.monthsShortRegex = function (e) {
      return this._monthsParseExact
        ...
        : (c(this, "_monthsShortRegex") || (this._monthsShortRegex = Re),
    ...
    (X.weekdaysMinRegex = function (e) {
      return this._weekdaysParseExact
        ...
        : (c(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = Qe),
    ...
    (d.lang = n("moment.lang is deprecated. Use moment.locale instead.", ht)),
    (d.langData = n(
