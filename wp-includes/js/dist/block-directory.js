this["wp"] = this["wp"] || {};
this["wp"]["blockDirectory"] = /******/ (function (modules) {
  // webpackBootstrap
  /******/ // The module cache
  ...
  /******/ {
    ...
    /***/ "7f3f": /***/ function (
      ...
      __webpack_require__.d(
        ...
        function () {
          return selectors_isRequestingDownloadableBlocks;
        }
      );
      __webpack_require__.d(
        selectors_namespaceObject,
      ...
      __webpack_require__.d(
        ...
        function () {
          return selectors_getErrorNoticeForBlock;
        }
      );
      ...
      const getUnusedBlockTypes = Object(
        external_wp_data_["createRegistrySelector"]
      )((select) => (state) => {
        const usedBlockTree = select(
          external_wp_blockEditor_["store"]
      ...
      function* actions_installBlockType(block) {
        ...
        try {
          ...
          const registeredBlocks = yield external_wp_data_["controls"].select(
            external_wp_blocks_["store"].name,
            "getBlockTypes"
          );
          ...
          yield external_wp_data_["controls"].dispatch(
            ...
            Object(external_wp_i18n_["sprintf"])(
              ...
              Object(external_wp_i18n_["__"])("Block %s installed and added."),
              block.title
            ),
            {
              speak: true,
          ...
          let message =
            error.message ||
            Object(external_wp_i18n_["__"])("An error occurred."); // Errors we throw are fatal

          let isFatal = error instanceof Error; // Specific API errors that are fatal

          const fatalAPIErrors = {
            folder_exists: Object(external_wp_i18n_["__"])(
              "This block is already installed. Try reloading the page."
            ),
            unable_to_connect_to_filesystem: Object(external_wp_i18n_["__"])(
      ...
      function* actions_uninstallBlockType(block) {
        try {
          ...
          yield external_wp_data_["controls"].dispatch(
            ...
            "createErrorNotice",
            error.message ||
              Object(external_wp_i18n_["__"])("An error occurred.")
          );
        }
      }
      /**
        ...
        *getDownloadableBlocks(filterValue) {
          ...
          try {
            ...
            const blocks = results.map((result) =>
              Object(external_lodash_["mapKeys"])(result, (value, key) => {
      ...
      function AutoBlockUninstaller() {
        const { uninstallBlockType } = Object(external_wp_data_["useDispatch"])(
          store
        );
        const shouldRemoveBlockTypes = Object(external_wp_data_["useSelect"])(
          (select) => {
        ...
        const unusedBlockTypes = Object(external_wp_data_["useSelect"])(
        ...
        Object(external_wp_element_["useEffect"])(() => {
          if (shouldRemoveBlockTypes && unusedBlockTypes.length) {
            unusedBlockTypes.forEach((blockType) => {
              ...
              Object(external_wp_blocks_["unregisterBlockType"])(
                blockType.name
              );
            });
          }
      ...
      const starHalf = Object(external_wp_element_["createElement"])(
        ...
        return Object(external_wp_element_["createElement"])(
          "span",
          {
            "aria-label": Object(external_wp_i18n_["sprintf"])(
              ...
              Object(external_wp_i18n_["__"])("%s out of 5 stars"),
              stars
            ),
          },
          Object(external_lodash_["times"])(fullStarCount, (i) =>
            Object(external_wp_element_["createElement"])(
          ...
          Object(external_lodash_["times"])(halfStarCount, (i) =>
            Object(external_wp_element_["createElement"])(
              build_module_icon["a" /* default */],
              {
                key: `half_stars_${i}`,
          ...
          Object(external_lodash_["times"])(emptyStarCount, (i) =>
            Object(external_wp_element_["createElement"])(
              build_module_icon["a" /* default */],
              {
                key: `empty_stars_${i}`,
      ...
      const DownloadableBlockNotice = ({ block }) => {
        const errorNotice = Object(external_wp_data_["useSelect"])(
        ...
        return Object(external_wp_element_["createElement"])(
          ...
          Object(external_wp_element_["createElement"])(
            ...
            errorNotice.message,
            errorNotice.isFatal
              ? " " + Object(external_wp_i18n_["__"])("Try reloading the page.")
              : null
          )
        );
      };
      ...
      function getDownloadableBlockLabel(
        ...
        if (!isInstalled && hasNotice) {
          ...
          return Object(external_wp_i18n_["sprintf"])(
            "Retry installing %s.",
            Object(external_wp_htmlEntities_["decodeEntities"])(title)
          );
        }
      ...
      function DownloadableBlockListItem({ composite, item, onClick }) {
        ...
        const isInstalled = !!Object(external_wp_blocks_["getBlockType"])(
          item.name
        );
        const { hasNotice, isInstalling, isInstallable } = Object(
        ...
        return Object(external_wp_element_["createElement"])(
          external_wp_components_["__unstableCompositeItem"],
          ...
          Object(external_wp_element_["createElement"])(
            ...
            isInstalling
              ...
              : Object(external_wp_element_["createElement"])(block_ratings, {
                  rating: rating,
                })
          ),
          Object(external_wp_element_["createElement"])(
            ...
            Object(external_wp_element_["createElement"])(
              ...
              Object(external_wp_element_["createInterpolateElement"])(
                Object(external_wp_i18n_["sprintf"])(
                  ...
                  Object(external_wp_i18n_["__"])("%1$s <span>by %2$s</span>"),
                  Object(external_wp_htmlEntities_["decodeEntities"])(title),
                  author
                ),
                {
              ...
              : Object(external_wp_element_["createElement"])(
                  ...
                  isInstallable &&
                    ...
                    Object(external_wp_element_["createElement"])(
                      ...
                      null,
                      Object(external_wp_i18n_["__"])("Install block")
                    )
                )
          )
        );
      ...
      function DownloadableBlocksList({
        ...
        const composite = Object(
          external_wp_components_["__unstableUseCompositeState"]
        )();
        const { installBlockType } = Object(external_wp_data_["useDispatch"])(
          store
        );
        ...
        return Object(external_wp_element_["createElement"])(
          external_wp_components_["__unstableComposite"],
          Object(esm_extends["a" /* default */])({}, composite, {
            role: "listbox",
          ...
          Object(external_wp_element_["createElement"])(
            ...
            Object(external_wp_element_["createElement"])(
              ...
              Object(external_wp_element_["createElement"])(
                ...
                Object(external_wp_i18n_["__"])("Available to install")
              ),
              Object(external_wp_element_["createElement"])(
                "p",
                {
      ...
      function DownloadableBlocksNoResults() {
        return Object(external_wp_element_["createElement"])(
          ...
          Object(external_wp_element_["createElement"])(
            "p",
            null,
            Object(external_wp_i18n_["__"])("No results found.")
          )
        );
      }
      ...
      function DownloadableBlocksPanel({
        ...
        return !!downloadableItems.length
          ...
          : !hasLocalBlocks &&
              Object(external_wp_element_["createElement"])(no_results, null);
      }
      ...
      /* harmony default export */ var downloadable_blocks_panel = Object(
        ...
        Object(external_wp_data_["withSelect"])(
          (select, { filterValue, rootClientId = null }) => {
      ...
      function InserterMenuDownloadableBlocksPanel() {
        const [debouncedFilterValue, setFilterValue] = Object(
          external_wp_element_["useState"]
        )("");
        const debouncedSetFilterValue = Object(external_lodash_["debounce"])(
          setFilterValue,
          400
        );
        return Object(external_wp_element_["createElement"])(
          external_wp_blockEditor_["__unstableInserterMenuExtension"],
          null,
              ...
              Object(external_wp_element_["createElement"])(
                ...
                Object(external_wp_element_["createElement"])(
                  ...
                  Object(external_wp_i18n_["sprintf"])(
                    ...
                    Object(external_wp_i18n_["__"])("By %s"),
                    author
                  )
                )
              )
      ...
      function InstalledBlocksPrePublishPanel() {
        const newBlockTypes = Object(external_wp_data_["useSelect"])(
        ...
        return Object(external_wp_element_["createElement"])(
          external_wp_editPost_["PluginPrePublishPanel"],
          {
            icon: block_default["a" /* default */],
          ...
          Object(external_wp_element_["createElement"])(CompactList, {
            items: newBlockTypes,
          })
        );
      }
      ...
      function InstallButton({ attributes, block, clientId }) {
        const isInstallingBlock = Object(external_wp_data_["useSelect"])(
          (select) => select(store).isInstalling(block.id)
        );
        const { installBlockType } = Object(external_wp_data_["useDispatch"])(
          store
        );
        const { replaceBlock } = Object(external_wp_data_["useDispatch"])(
          external_wp_blockEditor_["store"]
        );
        return Object(external_wp_element_["createElement"])(
            ...
            onClick: () =>
              installBlockType(block).then((success) => {
                if (success) {
                  ...
                  const [originalBlock] = Object(external_wp_blocks_["parse"])(
          ...
          Object(external_wp_i18n_["sprintf"])(
            ...
            Object(external_wp_i18n_["__"])("Install %s"),
            block.title
          )
        );
      }
      ...
      const getInstallMissing = (OriginalComponent) => (props) => {
        ...
        const { block, hasPermission } = Object(external_wp_data_["useSelect"])(
          (select) => {
            ...
            return {
              hasPermission: select(external_wp_coreData_["store"]).canUser(
                "read",
      ...
      const ModifiedWarning = ({ originalBlock, ...props }) => {
        ...
        const convertToHTML = () => {
          replaceBlock(
            props.clientId,
            Object(external_wp_blocks_["createBlock"])("core/html", {
        ...
        const hasHTMLBlock = Object(external_wp_blocks_["getBlockType"])(
          "core/html"
        );
        ...
        const actions = [
          Object(external_wp_element_["createElement"])(InstallButton, {
            key: "install",
            block: originalBlock,
