this["wp"] = this["wp"] || {};
this["wp"]["reusableBlocks"] = /******/ (function (modules) {
  // webpackBootstrap
  /******/ // The module cache
  ...
  /******/ {
    ...
    /***/ iqm2: /***/ function (
      ...
      const controls = {
        CONVERT_BLOCK_TO_STATIC: Object(
          ...
          const newBlocks = Object(external_wp_blocks_["parse"])(
            Object(external_lodash_["isFunction"])(reusableBlock.content)
        ...
        CONVERT_BLOCKS_TO_REUSABLE: Object(
          external_wp_data_["createRegistryControl"]
        )(
          (registry) =>
            async function ({ clientIds, title }) {
              const reusableBlock = {
                title:
                  title ||
                  Object(external_wp_i18n_["__"])("Untitled Reusable block"),
                content: Object(external_wp_blocks_["serialize"])(
                  registry
                    .select(external_wp_blockEditor_["store"])
              ...
              const newBlock = Object(external_wp_blocks_["createBlock"])(
                "core/block",
                {
          ...
          (registry) =>
            async function ({ id }) {
              ...
              const associatedBlocks = allBlocks.filter(
                (block) =>
                  Object(external_wp_blocks_["isReusableBlock"])(block) &&
      ...
      const reusable_block_reusableBlock = Object(
      ...
      /* harmony default export */ var reusable_block =
        reusable_block_reusableBlock;
      ...
      function ReusableBlockConvertButton({ clientIds, rootClientId }) {
        ...
        const canConvert = Object(external_wp_data_["useSelect"])(
          (select) => {
            ...
            const blocks =
              (_getBlocksByClientId = getBlocksByClientId(clientIds)) !==
                null && _getBlocksByClientId !== void 0
                ? _getBlocksByClientId
                : [];
            const isReusable =
              blocks.length === 1 &&
              blocks[0] &&
              Object(external_wp_blocks_["isReusableBlock"])(blocks[0]) &&
            ...
            const _canConvert = // Hide when this is already a reusable block.
              ...
              blocks.every(
                (
                  ...
                  Object(external_wp_blocks_["hasBlockSupport"])(
                    block.name,
                    "reusable",
                    true
                  )
        ...
        const onConvert = Object(external_wp_element_["useCallback"])(
          async function (reusableBlockTitle) {
            try {
              await convertBlocksToReusable(clientIds, reusableBlockTitle);
              createSuccessNotice(
                Object(external_wp_i18n_["__"])("Reusable block created."),
                {
                  type: "snackbar",
                }
              );
      ...
      function ReusableBlocksManageButton({ clientId }) {
        const { isVisible } = Object(external_wp_data_["useSelect"])(
          (select) => {
            const { getBlock } = select(external_wp_blockEditor_["store"]);
            const { canUser } = select("core");
            const reusableBlock = getBlock(clientId);
            return {
              isVisible:
                !!reusableBlock &&
                Object(external_wp_blocks_["isReusableBlock"])(reusableBlock) &&
      ...
      /* harmony default export */ var reusable_blocks_menu_items = Object(
