...
(this.wp = this.wp || {}),
  (this.wp.date = (function (c) {
    var M = {};
    function o(A) {
      if (M[A]) return M[A].exports;
      var a = (M[A] = { i: A, l: !1, exports: {} });
    ...
    return (
      ...
      (o.c = M),
      (o.d = function (c, M, A) {
        o.o(c, M) || Object.defineProperty(c, M, { enumerable: !0, get: A });
      }),
      (o.r = function (c) {
    ...
    "4CCe": function (c, M, o) {
      ...
      !(function (b, p) {
        ...
        c.exports
          ? (c.exports = p(o("f0Wu")))
          : ((a = [o("wy2R")]),
            void 0 === (z = "function" == typeof (A = p) ? A.apply(M, a) : A) ||
              (c.exports = z));
      })(0, function (c) {
        "use strict";
        if (!c.tz)
        ...
        function A(c) {
          ...
          for (M = 0; M < c.length - 1; M++)
            (A[M] = o(Math.round((c[M] - a) / 1e3) / 60, 1)), (a = c[M]);
          return A.join(" ");
        }
        function a(c) {
          var M,
            ...
            p = [],
            n = {};
          for (M = 0; M < c.abbrs.length; M++)
            void 0 === n[(A = c.abbrs[M] + "|" + c.offsets[M])] &&
              ((n[A] = a),
              (z[a] = c.abbrs[M]),
              (b[a] = o(Math.round(60 * c.offsets[M]) / 60, 1)),
              a++),
              (p[M] = o(n[A], 0));
        ...
        function b(c) {
          return (
            (function (c) {
              ...
              if (
                c.offsets.length !== c.untils.length ||
                c.offsets.length !== c.abbrs.length
              )
                throw new Error("Mismatched array lengths");
            })(c),
            [c.name, a(c), A(c.untils), z(c.population)].join("|")
          );
        }
        function p(c) {
        ...
        function n(c, M) {
          ...
          for (o = 0; o < c.length; o++) if (c[o] !== M[o]) return !1;
          return !0;
        }
        function i(c, M) {
          return (
            n(c.offsets, M.offsets) &&
            n(c.abbrs, M.abbrs) &&
            n(c.untils, M.untils)
          );
        }
          ...
          return (
            ...
            (function (c, M, o, A) {
              ...
              for (a = 0; a < c.length; a++) {
                for (e = !1, b = c[a], z = 0; z < r.length; z++)
                  i(b, (p = (n = r[z])[0])) &&
                    (b.population > p.population ||
                    (b.population === p.population && A && A[b.name])
                      ? n.unshift(b)
                      : n.push(b),
                    (e = !0));
                e || r.push([b]);
              ...
              for (a = 0; a < r.length; a++)
                for (n = r[a], M.push(n[0]), z = 1; z < n.length; z++)
                  o.push(n[0].name + "|" + n[z].name);
            })(c.zones, o, A, M),
            { version: c.version, zones: o, links: A.sort() }
          );
        }
        function r(c, M, o) {
          var A = Array.prototype.slice,
            a = (function (c, M, o) {
              var A,
                ...
                b = c.length + 1;
              for (
                o || (o = M), M > o && ((a = M), (M = o), (o = a)), a = 0;
                a < c.length;
                a++
              )
                null != c[a] &&
                  ((A = new Date(c[a]).getUTCFullYear()) < M && (z = a + 1),
                  A > o && (b = Math.min(b, a + 1)));
              return [z, b];
            })(c.untils, M, o),
        ...
        return (
          ...
          (c.tz.createLinks = e),
          (c.tz.filterYears = r),
          (c.tz.filterLinkPack = function (c, M, o, A) {
            var a,
              z,
              n = c.zones,
              i = [];
            ...
            for (
              z = e(
                { zones: i, links: c.links.slice(), version: c.version },
                A
              ),
                a = 0;
              a < z.zones.length;
              ...
              z.zones[a] = b(z.zones[a]);
            return (
              (z.countries = c.countries
    ...
    BWYS: function (c, M, o) {
      ...
      function L(c, M = new Date(), o) {
        return r(c, t(M, o));
      }
      function O(c, M = new Date()) {
        return r(c, a()(M).utc());
      }
      function q(c, M = new Date(), o) {
        if (!0 === o) return N(c, M);
        !1 === o && (o = void 0);
        const A = t(M, o);
        return A.locale(b.l10n.locale), r(c, A);
      }
      function N(c, M = new Date()) {
        const o = a()(M).utc();
      ...
      function t(c, M = "") {
        ...
        return M && !u(M)
          ...
          ? o.utcOffset(M)
          : b.timezone.string
          ? o.tz(b.timezone.string)
          : o.utcOffset(b.timezone.offset);
      }
      function u(c) {
      ...
      !(function (b, p) {
        ...
        function r(c) {
          var M = 0,
            ...
            b = 0,
            p = 1;
          for (45 === c.charCodeAt(0) && ((M = 1), (p = -1)); M < A.length; M++)
            b = 60 * b + e(A.charCodeAt(M));
          for (M = 0; M < a.length; M++)
            (z /= 60), (b += e(a.charCodeAt(M)) * z);
          return b * p;
        }
        function L(c) {
        ...
        function u(c, M) {
          for (var o, A; (A = 6e4 * (((M.at - c.at) / 12e4) | 0)); )
            (o = new f(new Date(c.at + A))).offset === c.offset
              ? (c = o)
              : (M = o);
          return c;
        }
        ...
        function X(c, M) {
          var o, A;
          for (L(M), o = 0; o < M.length; o++)
            (A = M[o]), (b[A] = b[A] || {}), (b[A][c] = !0);
        }
        function l(c) {
          var M,
            o,
            ...
            n = [];
          for (M = 0; M < a; M++)
            for (o in (A = b[c[M].offset] || {}))
              A.hasOwnProperty(o) && (p[o] = !0);
          ...
          var o,
            ...
            b = (function () {
              var c,
                ...
                z = [a];
              for (o = 1; o < 48; o++)
                (M = new f(new Date(A, o, 1))).offset !== a.offset &&
                  ((c = u(a, M)),
                  z.push(c),
                  z.push(new f(new Date(c.at + 6e4)))),
                  (a = M);
              for (o = 0; o < 4; o++)
                z.push(new f(new Date(A + o, 0, 1))),
                  z.push(new f(new Date(A + o, 6, 1)));
              return z;
            })(),
            p = b.length,
            n = l(b),
        ...
        function m(c, M) {
          ...
          return b instanceof N
            ...
            ? ((b = new N(b)), (o[c] = b), b)
            : A[c] && M !== m && (a = m(A[c], m))
            ? ((b = o[c] = new N())._set(a), (b.name = z[c]), b)
            : null;
        }
        function E(c) {
          var M, o, a, b;
        ...
        function R(M) {
          ...
          return (
            a && !c.isMoment(M) && C(z) && z.add(a.parse(z), "minutes"),
            z.tz(A),
            z
          );
        }
        (n < 2 || (2 === n && i < 6)) &&
          ...
          (N.prototype = {
            ...
            _index: function (c) {
              var M,
                o = +c,
                A = this.untils;
              for (M = 0; M < A.length; M++) if (o < A[M]) return M;
            },
            countries: function () {
              var c = this.name;
            ...
            parse: function (c) {
              ...
              for (a = 0; a < n; a++)
                if (
                  ...
                  (o = b[a + 1]),
                  (A = b[a ? a - 1 : a]),
                  M < o && R.moveAmbiguousForward
                    ? (M = o)
                    : M > A && R.moveInvalidForward && (M = A),
                  z < p[a] - 6e4 * M)
                )
                  return b[a];
              return b[n];
          ...
          (R.names = function () {
            var c,
              M = [];
            for (c in z)
              z.hasOwnProperty(c) && (o[c] || o[A[c]]) && z[c] && M.push(z[c]);
            return M.sort();
          }),
          (R.Zone = N),
          (R.unpack = q),
