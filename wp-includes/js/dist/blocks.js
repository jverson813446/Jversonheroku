  ...
  /******/ {
    ...
    /***/ "0ATp": /***/ function (
      ...
      __webpack_require__.d(
        ...
        function () {
          return /* reexport */ registerBlockTypeFromMetadata;
        }
      );
      __webpack_require__.d(
        __webpack_exports__,
      ...
      __webpack_require__.d(
        ...
        "setDefaultBlockName",
        function () {
          return /* reexport */ registration_setDefaultBlockName;
        }
      );
      __webpack_require__.d(
        __webpack_exports__,
        "getDefaultBlockName",
        function () {
          return /* reexport */ registration_getDefaultBlockName;
        }
      );
      __webpack_require__.d(
        __webpack_exports__,
        ...
        function () {
          return /* reexport */ registration_setGroupingBlockName;
        }
      );
      __webpack_require__.d(
        __webpack_exports__,
        ...
        function () {
          return /* reexport */ registration_getGroupingBlockName;
        }
      );
      __webpack_require__.d(__webpack_exports__, "getBlockType", function () {
        return /* reexport */ registration_getBlockType;
      });
      __webpack_require__.d(__webpack_exports__, "getBlockTypes", function () {
        return /* reexport */ registration_getBlockTypes;
      });
      __webpack_require__.d(
        __webpack_exports__,
        "getBlockSupport",
        function () {
          return /* reexport */ registration_getBlockSupport;
        }
      );
      __webpack_require__.d(
        __webpack_exports__,
        "hasBlockSupport",
        function () {
          return /* reexport */ registration_hasBlockSupport;
        }
      );
      __webpack_require__.d(
        __webpack_exports__,
        "getBlockVariations",
        function () {
          return /* reexport */ registration_getBlockVariations;
        }
      );
      __webpack_require__.d(
        __webpack_exports__,
      ...
      __webpack_require__.d(__webpack_exports__, "isTemplatePart", function () {
      ...
      __webpack_require__.d(
        ...
        "getChildBlockNames",
        function () {
          return /* reexport */ registration_getChildBlockNames;
        }
      );
      __webpack_require__.d(__webpack_exports__, "hasChildBlocks", function () {
        return /* reexport */ registration_hasChildBlocks;
      });
      __webpack_require__.d(
        __webpack_exports__,
        "hasChildBlocksWithInserterSupport",
        function () {
          return /* reexport */ registration_hasChildBlocksWithInserterSupport;
        }
      );
      __webpack_require__.d(
        __webpack_exports__,
      ...
      __webpack_require__.d(
        ...
        "hasChildBlocksWithInserterSupport",
        function () {
          return hasChildBlocksWithInserterSupport;
        }
      );
            ...
            return {
              ...
              ...Object(external_lodash_["keyBy"])(
                Object(external_lodash_["map"])(
                  action.blockTypes,
                  (blockType) =>
                    Object(external_lodash_["omit"])(blockType, "styles ")
                ),
                "name"
              ),
            };
      ...
      function blockStyles(state = {}, action) {
        switch (action.type) {
          ...
          case "ADD_BLOCK_STYLES":
            return {
              ...state,
              [action.blockName]: Object(external_lodash_["uniqBy"])(
                [
                  ...Object(external_lodash_["get"])(
                    state,
                    [action.blockName],
          ...
          case "REMOVE_BLOCK_STYLES":
            return {
              ...state,
              [action.blockName]: Object(external_lodash_["filter"])(
                Object(external_lodash_["get"])(state, [action.blockName], []),
      ...
      const reducer_defaultBlockName = createBlockNameSetterReducer(
      ...
      function reducer_categories(state = DEFAULT_CATEGORIES, action) {
        switch (action.type) {
          ...
          case "UPDATE_CATEGORY": {
            ...
            const categoryToChange = Object(external_lodash_["find"])(state, [
              "slug",
              action.slug,
            ]);
      ...
      const getBlockTypes = Object(rememo["a" /* default */])(
        (state) => {
      ...
      const getBlockVariations = Object(rememo["a" /* default */])(
      ...
      function getDefaultBlockVariation(state, blockName, scope) {
        const variations = getBlockVariations(state, blockName, scope);
        return (
          Object(external_lodash_["findLast"])(variations, "isDefault") ||
          Object(external_lodash_["first"])(variations)
        );
      }
      /**
      ...
      const getChildBlockNames = Object(rememo["a" /* default */])(
        (state, blockName) => {
      ...
      function isMatchingSearchTerm(state, nameOrType, searchTerm) {
        const blockType = getNormalizedBlockType(state, nameOrType);
        const getNormalizedSearchTerm = Object(external_lodash_["flow"])([
        ...
        const isSearchMatch = Object(external_lodash_["flow"])([
      ...
      const hasChildBlocksWithInserterSupport = (state, blockName) => {
        return Object(external_lodash_["some"])(
          getChildBlockNames(state, blockName),
          (childBlockName) => {
      ...
      function isUnmodifiedDefaultBlock(block) {
        ...
        return Object(external_lodash_["every"])(
      ...
      function isValidIcon(icon) {
        return (
          ...
          (Object(external_lodash_["isString"])(icon) ||
            Object(external_wp_element_["isValidElement"])(icon) ||
            Object(external_lodash_["isFunction"])(icon) ||
            icon instanceof external_wp_element_["Component"])
        );
      }
      /**
      ...
      function getAccessibleBlockLabel(
        ...
        if (hasPosition && direction === "vertical") {
          if (hasLabel) {
            return Object(external_wp_i18n_["sprintf"])(
              ...
              Object(external_wp_i18n_["__"])("%1$s Block. Row %2$d. %3$s"),
              title,
              position,
              label
            );
          ...
          return Object(external_wp_i18n_["sprintf"])(
            ...
            Object(external_wp_i18n_["__"])("%1$s Block. Row %2$d"),
            title,
            position
          );
          ...
          if (hasLabel) {
            return Object(external_wp_i18n_["sprintf"])(
              ...
              Object(external_wp_i18n_["__"])("%1$s Block. Column %2$d. %3$s"),
              title,
              position,
              label
            );
          ...
          return Object(external_wp_i18n_["sprintf"])(
            ...
            Object(external_wp_i18n_["__"])("%1$s Block. Column %2$d"),
            title,
            position
          );
        }
        ...
        if (hasLabel) {
          return Object(external_wp_i18n_["sprintf"])(
            ...
            Object(external_wp_i18n_["__"])("%1$s Block. %2$s"),
            title,
            label
          );
        }
        ...
        return Object(external_wp_i18n_["sprintf"])(
          ...
          Object(external_wp_i18n_["__"])("%s Block"),
          title
        );
      }
      /**
      ...
      function __experimentalGetBlockAttributesNamesByRole(name, role) {
        ...
        const attributes =
          (_getBlockType = registration_getBlockType(name)) === null ||
      ...
      function unstable__bootstrapServerSideBlockDefinitions(definitions) {
        for (const blockName of Object.keys(definitions)) {
          ...
          serverSideBlockDefinitions[blockName] = Object(
            external_lodash_["mapKeys"]
          )(
            Object(external_lodash_["pickBy"])(
              definitions[blockName],
              (value) => !Object(external_lodash_["isNil"])(value)
            ),
            (value, key) => Object(external_lodash_["camelCase"])(key)
          );
        }
      }
      /**
      ...
      function getBlockSettingsFromMetadata({ textdomain, ...metadata }) {
        ...
        const settings = Object(external_lodash_["pick"])(
          metadata,
          allowedFields
        );
      ...
      function registerBlockType(blockNameOrMetadata, settings) {
        const name = Object(external_lodash_["isObject"])(blockNameOrMetadata)
        ...
        settings = Object(external_wp_hooks_["applyFilters"])(
        ...
        if (settings.deprecated) {
          settings.deprecated = settings.deprecated.map((deprecation) =>
            Object(external_lodash_["pick"])(
              // Only keep valid deprecation keys.
              Object(external_wp_hooks_["applyFilters"])(
        ...
        if (
          ...
          !Object(external_lodash_["some"])(
            Object(external_wp_data_["select"])(store).getCategories(),
            {
      ...
      function translateBlockSettingUsingI18nSchema(
        ...
        if (
          Object(external_lodash_["isString"])(i18nSchema) &&
          Object(external_lodash_["isString"])(settingValue)
        ) {
          // eslint-disable-next-line @wordpress/i18n-no-variables, @wordpress/i18n-text-domain
          return Object(external_wp_i18n_["_x"])(
            settingValue,
            i18nSchema,
            textdomain
          );
        ...
        if (
          Object(external_lodash_["isArray"])(i18nSchema) &&
          !Object(external_lodash_["isEmpty"])(i18nSchema) &&
          Object(external_lodash_["isArray"])(settingValue)
        ) {
        ...
        if (
          Object(external_lodash_["isObject"])(i18nSchema) &&
          !Object(external_lodash_["isEmpty"])(i18nSchema) &&
          Object(external_lodash_["isObject"])(settingValue)
        ) {
      ...
      function registerBlockCollection(namespace, { title, icon }) {
        Object(external_wp_data_["dispatch"])(store).addBlockCollection(
          namespace,
          title,
          icon
        );
      ...
      function unregisterBlockCollection(namespace) {
        Object(external_wp_data_["dispatch"])(store).removeBlockCollection(
          namespace
        );
      }
      /**
      ...
      function unregisterBlockType(name) {
        const oldBlock = Object(external_wp_data_["select"])(
          store
        ).getBlockType(name);
      ...
      function registration_getBlockSupport(
        ...
        return Object(external_wp_data_["select"])(store).getBlockSupport(
          nameOrType,
          feature,
          defaultSupports
        );
      ...
      function registration_hasBlockSupport(
        ...
        return Object(external_wp_data_["select"])(store).hasBlockSupport(
          nameOrType,
          feature,
          defaultSupports
        );
      ...
      const registration_getChildBlockNames = (blockName) => {
        return Object(external_wp_data_["select"])(store).getChildBlockNames(
          blockName
        );
      };
      /**
      ...
      const registration_hasChildBlocks = (blockName) => {
        return Object(external_wp_data_["select"])(store).hasChildBlocks(
          blockName
        );
      };
      /**
      ...
      const registerBlockStyle = (blockName, styleVariation) => {
        Object(external_wp_data_["dispatch"])(store).addBlockStyles(
          blockName,
          styleVariation
        );
      };
      ...
      const unregisterBlockStyle = (blockName, styleVariationName) => {
        Object(external_wp_data_["dispatch"])(store).removeBlockStyles(
          blockName,
          styleVariationName
        );
      };
      ...
      const registration_getBlockVariations = (blockName, scope) => {
        return Object(external_wp_data_["select"])(store).getBlockVariations(
          blockName,
          scope
        );
      };
      ...
      const registerBlockVariation = (blockName, variation) => {
        Object(external_wp_data_["dispatch"])(store).addBlockVariations(
          blockName,
          variation
        );
      };
      ...
      const unregisterBlockVariation = (blockName, variationName) => {
        Object(external_wp_data_["dispatch"])(store).removeBlockVariations(
          blockName,
          variationName
        );
      };
      ...
      const getBlockTypesForPossibleFromTransforms = (blocks) => {
        ...
        const blockTypesWithPossibleFromTransforms = Object(
      ...
      const getBlockTypesForPossibleToTransforms = (blocks) => {
        ...
        const possibleTransforms = Object(external_lodash_["filter"])(
          transformsTo,
          (transform) => {
            return (
        ...
        const blockNames = Object(external_lodash_["flatMap"])(
          possibleTransforms,
      ...
      const isContainerGroupBlock = (name) =>
        name === registration_getGroupingBlockName();
      /**
      ...
      function getBlockTransforms(direction, blockTypeOrName) {
        ...
        const filteredTransforms = usingMobileTransformations
          ? Object(external_lodash_["filter"])(transforms[direction], (t) => {
              if (t.type === "raw") {
                return true;
              }
      ...
      function switchToBlockType(blocks, name) {
        ...
        if (
          transformationResults.some(
            (result) => !registration_getBlockType(result.name)
          )
        ) {
          return null;
        }

        const hasSwitchedBlock = Object(external_lodash_["some"])(
          transformationResults,
        ...
        const ret = transformationResults.map((result) => {
           ...
           */
          return Object(external_wp_hooks_["applyFilters"])(
      ...
      const getBlockFromExample = (name, example) => {
        return createBlock(
          name,
          example.attributes,
          Object(external_lodash_["map"])(example.innerBlocks, (innerBlock) =>
      ...
      var external_wp_blockSerializationDefaultParser_ =
        __webpack_require__("ouCq");
      ...
      function createLogger() {
        ...
        function createLogHandler(logger) {
          let log = (message, ...args) =>
            logger("Block validation: " + message, ...args); // In test environments, pre-process string substitutions to improve
      ...
      var external_wp_isShallowEqual_default =
        /*#__PURE__*/ __webpack_require__.n(external_wp_isShallowEqual_);
      ...
      const { Consumer, Provider } = Object(
        external_wp_element_["createContext"]
      )(() => {});
      /**
      ...
      const withBlockContentContext = Object(
      ...
      /* harmony default export */ var block_content_provider =
        BlockContentProvider;
      ...
      function getSaveElement(blockTypeOrName, attributes, innerBlocks = []) {
        ...
        const hasLightBlockWrapper =
          ...
          registration_hasBlockSupport(blockType, "lightBlockWrapper", false);

        if (
          Object(external_lodash_["isObject"])(element) &&
          Object(external_wp_hooks_["hasFilter"])(
            "blocks.getSaveContent.extraProps"
          ) &&
           ...
           * @param {Object}  attributes Block attributes.
           */
          const props = Object(external_wp_hooks_["applyFilters"])(
            "blocks.getSaveContent.extraProps",
            { ...element.props },
            blockType,
            attributes
          ...
          if (!external_wp_isShallowEqual_default()(props, element.props)) {
            element = Object(external_wp_element_["cloneElement"])(
              element,
              props
            );
          }
        ...
        element = Object(external_wp_hooks_["applyFilters"])(
      ...
      function getSaveContent(blockTypeOrName, attributes, innerBlocks) {
        const blockType = normalizeBlockType(blockTypeOrName);
        return Object(external_wp_element_["renderToString"])(
      ...
      function getCommentDelimitedContent(rawBlockName, attributes, content) {
        const serializedAttributes = !Object(external_lodash_["isEmpty"])(
          attributes
        )
          ? serializeAttributes(attributes) + " "
          : ""; // Strip core blocks of their namespace prefix.

        const blockName = Object(external_lodash_["startsWith"])(
          rawBlockName,
          "core/"
        )
      ...
      class validation_DecodeEntityParser {
        ...
        parse(entity) {
          if (isValidCharacterReference(entity)) {
            return Object(external_wp_htmlEntities_["decodeEntities"])(
              "&" + entity + ";"
            );
          }
        }
      ...
      function isEquivalentTextTokens(
        actual,
        expected,
        logger = createLogger()
      ) {
      ...
      const isEqualAttributesOfName = {
        class: (actual, expected) => {
          ...
          return !Object(external_lodash_["xor"])(
      ...
      function getBlockContentValidationResult(
        blockTypeOrName,
        attributes,
      ...
      function concat(...blockNodes) {
        ...
        for (let i = 0; i < blockNodes.length; i++) {
          const blockNode = Object(external_lodash_["castArray"])(
            blockNodes[i]
          );
      ...
      function matcherFromSource(sourceConfig) {
        switch (sourceConfig.source) {
          ...
          case "query":
            const subMatchers = Object(external_lodash_["mapValues"])(
              sourceConfig.query,
              matcherFromSource
            );
      ...
      function getBlockAttributes(blockTypeOrName, innerHTML, attributes = {}) {
        const blockType = normalizeBlockType(blockTypeOrName);
        const blockAttributes = Object(external_lodash_["mapValues"])(
          blockType.attributes,
      ...
      function getMigratedBlock(block, parsedAttributes) {
        ...
        const { originalContent, innerBlocks } = block; // By design, blocks lack any sort of version tracking. Instead, to process
        ...
        for (let i = 0; i < deprecatedDefinitions.length; i++) {
          ...
          const { isEligible = external_lodash_["stubFalse"] } =
        ...
        if (name && name.indexOf("core-embed/") === 0) {
          ...
          newAttributes.providerNameSlug =
            providerSlug in deprecated
              ...
              : providerSlug; // this is needed as the `responsive` attribute was passed
      ...
      function createBlockWithFallback(blockNode) {
        const { blockName: originalName } = blockNode; // The fundamental structure of a blocktype includes its attributes, inner
        // blocks, and inner HTML. It is important to distinguish inner blocks from
        // the HTML content of the block as only the latter is relevant for block
        // validation and edit operations.

        let { attrs: attributes, innerBlocks = [], innerHTML } = blockNode;
        const { innerContent } = blockNode; // Blocks that don't have a registered handler are considered freeform.
        ...
        ({ name, attributes } = convertLegacyBlocks(name, attributes)); // Fallback content may be upgraded from classic content expecting implicit
      ...
      const parseWithGrammar = createParse(
        external_wp_blockSerializationDefaultParser_["parse"]
      );
      ...
      function specialCommentConverter(node, doc) {
        ...
        if (node.nodeValue.indexOf("more") === 0) {
          ...
          Object(external_wp_dom_["replace"])(
            node,
      ...
      function phrasingContentReducer(node, doc) {
        ...
        if (node.nodeName === "SPAN" && node.style) {
          ...
          if (
            ...
            Object(external_lodash_["includes"])(textDecoration, "line-through")
          ) {
      ...
      function isFigureContent(node, schema) {
        ...
        if (
          tag === "figcaption" ||
          Object(external_wp_dom_["isTextContent"])(node)
        ) {
          return false;
        }
      ...
      function segmentHTMLToShortcodeBlock(
        ...
        const transformation = findTransform(
          ...
          (transform) =>
            ...
            Object(external_lodash_["some"])(
              ...
              (tag) => Object(external_wp_shortcode_["regexp"])(tag).test(HTML)
            )
        );
        ...
        const transformTags = Object(external_lodash_["castArray"])(
          transformation.tag
        );
        const transformTag = Object(external_lodash_["find"])(
          transformTags,
          (tag) => Object(external_wp_shortcode_["regexp"])(tag).test(HTML)
        );
        let match;
        ...
        if (
          (match = Object(external_wp_shortcode_["next"])(
            transformTag,
            HTML,
            lastIndex
          ))
          ...
          const attributes = Object(external_lodash_["mapValues"])(
            Object(external_lodash_["pickBy"])(
      ...
      function getBlockContentSchemaFromTransforms(transforms, context) {
        const phrasingContentSchema = Object(
          external_wp_dom_["getPhrasingContentSchema"]
        )(context);
        const schemaArgs = {
        ...
        const schemas = transforms.map(({ isMatch, blockName, schema }) => {
          const hasAnchorSupport = registration_hasBlockSupport(
            blockName,
            "anchor"
          );
          schema = Object(external_lodash_["isFunction"])(schema)
            ? schema(schemaArgs)
      ...
      function getSibling(node, which) {
        ...
        if (
          !parentNode ||
          !Object(external_wp_dom_["isPhrasingContent"])(parentNode)
        ) {
          return;
        }
      ...
      function filterInlineHTML(HTML, preserveWhiteSpace) {
        ...
        HTML = Object(external_wp_dom_["removeInvalidHTML"])(
          HTML,
          Object(external_wp_dom_["getPhrasingContentSchema"])("paste"),
          {
            inline: true,
          }
        );
      ...
      function pasteHandler({
        ...
        const blocks = Object(external_lodash_["compact"])(
          Object(external_lodash_["flatMap"])(pieces, (piece) => {
            ...
            piece = Object(external_wp_dom_["removeInvalidHTML"])(
              piece,
              schema
            );
        ...
        if (
          ...
          if (
            ...
            return Object(external_wp_dom_["removeInvalidHTML"])(
      ...
      function categories_updateCategory(slug, category) {
        Object(external_wp_data_["dispatch"])(store).updateCategory(
          slug,
          category
        );
      }
      ...
      function doBlocksMatchTemplate(blocks = [], template = []) {
        return (
          ...
          Object(external_lodash_["every"])(
            template,
            ([name, , innerBlocksTemplate], index) => {
      ...
      function synchronizeBlocksWithTemplate(blocks = [], template) {
        ...
        return Object(external_lodash_["map"])(
          ...
          ([name, attributes, innerBlocksTemplate], index) => {
            ...
            const { name: blockName, attributes: blockAttributes } =
    ...
    /***/ "7Cbv": /***/ function (
      ...
      /* harmony default export */ var esm_browser_v4 = (__webpack_exports__[
        "a"
      ] = v4);
    ...
    /***/ M55E: /***/ function (module, exports, __webpack_require__) {
    ...
    */
    ...
    /***/ Zss7: /***/ function (module, exports, __webpack_require__) {
