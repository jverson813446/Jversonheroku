    ...
    /***/ t1DA: /***/ function (
      ...
      const code_code = {
        ...
        __unstableInputRule(value) {
          ...
          value = Object(external_wp_richText_["remove"])(
            value,
            startIndex,
            startIndex + 1
          );
      ...
      function isValidHref(href) {
        ...
        if (/^\S+:/.test(trimmedHref)) {
          ...
          const authority = Object(external_wp_url_["getAuthority"])(
            trimmedHref
          );
          ...
          const queryString = Object(external_wp_url_["getQueryString"])(
            trimmedHref
          );
          ...
          if (
            fragment &&
            !Object(external_wp_url_["isValidFragment"])(fragment)
          ) {
            return false;
          }
      ...
      function createLinkFormat({ url, type, id, opensInNewWindow }) {
        const format = {
          type: "core/link",
          attributes: {
            url,
      ...
      function InlineLinkUI({
         ...
         */
        const [nextLinkValue, setNextLinkValue] = Object(
          external_wp_element_["useState"]
        )();
        const linkValue = {
        ...
        function onChangeLink(nextValue) {
          ...
          if (
            Object(external_wp_richText_["isCollapsed"])(value) &&
            !isActive
          ) {
            ...
            const newValue = Object(external_wp_richText_["applyFormat"])(
              value,
              format
            );
          ...
          if (!isValidHref(newUrl)) {
            ...
            speak(
              Object(external_wp_i18n_["__"])("Link inserted."),
              "assertive"
            );
          }
        }
      ...
      function link_Edit({
        ...
        const [addingLink, setAddingLink] = Object(
          external_wp_element_["useState"]
        )(false);
        ...
        function onRemoveFormat() {
          onChange(
            Object(external_wp_richText_["removeFormat"])(value, link_name)
          );
      ...
      const link_link = {
        ...
        __unstablePasteRule(value, { html, plainText }) {
          ...
          return Object(external_wp_richText_["applyFormat"])(value, {
            type: link_name,
            attributes: {
              url: Object(external_wp_htmlEntities_["decodeEntities"])(
                pastedText
              ),
            },
          });
      ...
      const strikethrough_title = Object(external_wp_i18n_["__"])(
        "Strikethrough"
      );
      ...
      function getActiveColor(formatName, formatValue, colors) {
        const activeColorFormat = Object(
          external_wp_richText_["getActiveFormat"]
        ...
        const onColorChange = Object(external_wp_element_["useCallback"])(
          (color) => {
            if (color) {
              ...
              onChange(
                Object(external_wp_richText_["removeFormat"])(value, name)
              );
            }
          },
          [colors, onChange]
        );
        const activeColor = Object(external_wp_element_["useMemo"])(
      ...
      function InlineColorUI({ name, value, onChange, onClose, contentRef }) {
        const anchorRef = Object(external_wp_richText_["useAnchorRef"])({
          ref: contentRef,
          value,
          settings: textColor,
      ...
      function TextColorEdit({
        ...
        const allowCustomControl = Object(
          external_wp_blockEditor_["useSetting"]
        )("color.custom");
        const colors =
          Object(external_wp_blockEditor_["useSetting"])("color.palette") ||
          EMPTY_ARRAY;
        const [isAddingColor, setIsAddingColor] = Object(
          external_wp_element_["useState"]
        )(false);
        ...
        const disableIsAddingColor = Object(
          external_wp_element_["useCallback"]
        )(() => setIsAddingColor(false), [setIsAddingColor]);
        const colorIndicatorStyle = Object(
          ...
          Object(external_wp_element_["createElement"])(
            external_wp_blockEditor_["RichTextToolbarButton"],
            {
              ...
              onClick: hasColorsToChoose
                ...
                : () =>
                    onChange(
                      Object(external_wp_richText_["removeFormat"])(
                        value,
                        text_color_name
                      )
                    ),
