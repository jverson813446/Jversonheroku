    ...
    /***/ "9pbN": /***/ function (
      ...
      function MoreMenu() {
        ...
        return Object(external_wp_element_["createElement"])(
          ...
          null,
          Object(external_wp_element_["createElement"])(
            external_wp_components_["ToolbarDropdownMenu"],
            {
            ...
            Object(external_wp_element_["createElement"])(
              ...
              Object(external_wp_element_["createElement"])(
                external_wp_components_["ToolbarButton"],
                {
                  ...
                  shortcut:
                    external_wp_keycodes_["displayShortcut"].primary("z"), // If there are no undo levels we don't want to actually disable this
      ...
      function useInserter(inserter) {
        const [isInserterOpened, setIsInserterOpened] = Object(
          external_wp_element_["useState"]
        )(() => inserter.isOpen);
        Object(external_wp_element_["useEffect"])(() => {
      ...
      function blockToWidget(block, existingWidget = null) {
        ...
        return {
          ...Object(external_lodash_["omit"])(existingWidget, [
            "form",
            "rendered",
          ]),
          ...widget,
      ...
      function widgetToBlock({ id, idBase, number, instance }) {
        ...
        if (idBase === "block") {
          ...
          block = Object(external_wp_blocks_["createBlock"])(
            "core/legacy-widget",
            {
              idBase,
              instance: {
        ...
        Object(external_wp_element_["useEffect"])(() => {
          return sidebar.subscribe((prevWidgets, nextWidgets) => {
            setBlocks((prevBlocks) => {
              ...
              if (
                external_wp_isShallowEqual_default()(prevBlocks, nextBlocks)
              ) {
                return prevBlocks;
              }
          ...
          (nextBlocks) => {
            setBlocks((prevBlocks) => {
              ...
              const nextWidgets = nextBlocks.map((nextBlock) => {
                const widgetId = Object(
                  external_wp_widgets_["getWidgetIdFromBlock"]
                )(nextBlock); // Update existing widgets.
      ...
      const FocusControlContext = Object(
      ...
      function SidebarEditorProvider({ sidebar, settings, children }) {
      ...
      function BlockAppender(props) {
        ...
        const isBlocksListEmpty = Object(external_wp_data_["useSelect"])(
          (select) =>
            select(external_wp_blockEditor_["store"]).getBlockCount() === 0
      ...
      function SidebarBlockEditor({
        ...
        const {
          ...
          return {
            ...
            isWelcomeGuideActive:
              select(store).__unstableIsFeatureActive("welcomeGuide"),
          };
        }, []);
      ...
      const SidebarControlsContext = Object(
        external_wp_element_["createContext"]
      )();
      ...
      function useActiveSidebarControl() {
        const { activeSidebarControl } = Object(
      ...
      function useClearSelectedBlock(sidebarControl, popoverRef) {
        const { hasSelectedBlock, hasMultiSelection } = Object(
          external_wp_data_["useSelect"]
        )(external_wp_blockEditor_["store"]);
      ...
      function CustomizeWidgets({ api, sidebarControls, blockEditorSettings }) {
            ...
            if (!this.isOpen) {
              ...
              this.expand({
                completeCallback() {
                  ...
                  const searchBox =
                    external_wp_dom_["focus"].tabbable.find(
                      contentContainer
                    )[1];
      ...
      function getSidebarControl() {
        ...
        return class SidebarControl extends customize.Control {
          ...
          ready() {
            ...
            this.sidebarAdapter = new sidebar_adapter_SidebarAdapter(
              this.setting,
              customize
            );
          }
      ...
      const withMoveToSidebarToolbarItem = Object(
        ...
        (BlockEdit) => (props) => {
          let widgetId = Object(external_wp_widgets_["getWidgetIdFromBlock"])(
            props
          );
          ...
          const canInsertBlockInSidebar = Object(
            external_wp_data_["useSelect"]
          )(
            (select) => {
          ...
          function moveToSidebar(sidebarControlId) {
            ...
            if (widgetId) {
              ...
              oldSetting(
                Object(external_lodash_["without"])(oldSetting(), widgetId)
              );
      ...
      const withWideWidgetDisplay = Object(
        external_wp_compose_["createHigherOrderComponent"]
      )(
        (BlockEdit) => (props) => {
