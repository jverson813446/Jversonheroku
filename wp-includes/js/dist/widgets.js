this["wp"] = this["wp"] || {};
this["wp"]["widgets"] = /******/ (function (modules) {
  // webpackBootstrap
  /******/ // The module cache
  ...
  /******/ {
    ...
    /***/ "4g8P": /***/ function (
      ...
      __webpack_require__.d(
        ...
        "metadata",
        function () {
          return legacy_widget_metadata;
        }
      );
      __webpack_require__.d(legacy_widget_namespaceObject, "name", function () {
      ...
      const widget_widget = Object(external_wp_element_["createElement"])(
      ...
      const brush = Object(external_wp_element_["createElement"])(
        external_wp_primitives_["SVG"],
        {
          xmlns: "https://www.w3.org/2000/svg",
          viewBox: "0 0 24 24",
      ...
      function WidgetTypeSelector({ selectedId, onSelect }) {
        ...
        if (widgetTypes.length === 0) {
          return Object(external_wp_i18n_["__"])(
        ...
        return Object(external_wp_element_["createElement"])(
          external_wp_components_["SelectControl"],
          {
            ...
            value:
              selectedId !== null && selectedId !== void 0 ? selectedId : "",
            options: [
              {
                value: "",
      ...
      class control_Control {
        ...
        constructor({
          ...
          this.handleFormChange = Object(external_lodash_["debounce"])(
      ...
      function Form({
        ...
        const isMediumLargeViewport = Object(
          external_wp_compose_["useViewportMatch"]
        )("small"); // We only want to remount the control when the instance changes
        // *externally*. For example, if the user performs an undo. To do this, we
        // keep track of changes made to instance by the control itself and then
        // ignore those.

        const outgoingInstances = Object(external_wp_element_["useRef"])(
          new Set()
        );
        const incomingInstances = Object(external_wp_element_["useRef"])(
          new Set()
        );
      ...
      function Preview({ idBase, instance, isVisible }) {
        const [isLoaded, setIsLoaded] = Object(
          external_wp_element_["useState"]
        )(false); // Resize the iframe on either the load event, or when the iframe becomes visible.

        const ref = Object(external_wp_compose_["useRefEffect"])(
          (iframe) => {
        ...
        return Object(external_wp_element_["createElement"])(
          ...
          isVisible &&
            !isLoaded &&
            Object(external_wp_element_["createElement"])(
              external_wp_components_["Placeholder"],
              null,
              Object(external_wp_element_["createElement"])(
                external_wp_components_["Spinner"],
                null
          ...
          Object(external_wp_element_["createElement"])(
            ...
            Object(external_wp_element_["createElement"])(
              external_wp_components_["Disabled"],
              null,
      ...
      function NoPreview({ name }) {
        return Object(external_wp_element_["createElement"])(
          ...
          name &&
            Object(external_wp_element_["createElement"])("h3", null, name),
          Object(external_wp_element_["createElement"])(
            "p",
            null,
            Object(external_wp_i18n_["__"])("No preview available.")
          )
        );
      }
            ...
            onClick: () => {
              if (rawInstance.title) {
                replaceBlocks(clientId, [
                  Object(external_wp_blocks_["createBlock"])("core/heading", {
      ...
      function Edit(props) {
        ...
        return Object(external_wp_element_["createElement"])(
          ...
          blockProps,
          !id && !idBase
            ? Object(external_wp_element_["createElement"])(Empty, props)
            : Object(external_wp_element_["createElement"])(NotEmpty, props)
        );
      }
      ...
      function NotEmpty({
        ...
        const [hasPreview, setHasPreview] = Object(
          external_wp_element_["useState"]
        )(null);
        const { widgetType, hasResolvedWidgetType, isNavigationMode } = Object(
          external_wp_data_["useSelect"]
        )(
          (select) => {
            const widgetTypeId = id !== null && id !== void 0 ? id : idBase;
            return {
              widgetType: select(external_wp_coreData_["store"]).getWidgetType(
                widgetTypeId
              ),
        ...
        const setInstance = Object(external_wp_element_["useCallback"])(
          (nextInstance) => {
            setAttributes({
        ...
        return Object(external_wp_element_["createElement"])(
          ...
          Object(external_wp_element_["createElement"])(
            ...
            null,
            Object(external_wp_element_["createElement"])(InspectorCard, {
          ...
          idBase &&
            Object(external_wp_element_["createElement"])(
              ...
              hasPreview === true &&
                Object(external_wp_element_["createElement"])(Preview, {
                  idBase: idBase,
                  instance: instance,
              ...
              hasPreview === false &&
                mode === "preview" &&
                Object(external_wp_element_["createElement"])(NoPreview, {
                  name: widgetType.name,
                })
            )
        );
      ...
      const legacyWidgetTransforms = [
        ...
        return {
          ...
          transform: ({ instance }) => {
            ...
            const transformedBlock = Object(external_wp_blocks_["createBlock"])(
              block,
      ...
      const { name: legacy_widget_name } = legacy_widget_metadata;
      ...
      const moveTo = Object(external_wp_element_["createElement"])(
        external_wp_primitives_["SVG"],
        {
          xmlns: "https://www.w3.org/2000/svg",
          viewBox: "0 0 24 24",
      ...
      function MoveToWidgetArea({
        ...
        return Object(external_wp_element_["createElement"])(
          external_wp_components_["ToolbarGroup"],
          null,
          Object(external_wp_element_["createElement"])(
        ...
        const unsubscribe = Object(external_wp_data_["subscribe"])(() => {
          ...
          const hiddenIds =
            ...
            _settings$widgetTypes !== void 0
              ...
              : [];
          const widgetTypes =
            (_select$getWidgetType = Object(external_wp_data_["select"])(
              external_wp_coreData_["store"]
            ).getWidgetTypes({
              per_page: -1,
            })) === null || _select$getWidgetType === void 0
